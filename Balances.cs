    ...
    public partial class Balances : Form
    {
        ...
        private void Balances_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT  [refID],[clientName],[phoneNo],[Total],[discount],[AmountPaid],[agentID],[agent_fee],[SalesStatus],[OrderStatus],[userID],[Date],[supplier_fee],[company_fee],[office_fee],[office_expense] FROM [supubana].[dbo].[sales] WHERE [Total]-[discount]>[AmountPaid] AND [OrderStatus]='Invoice'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "")
            {
                ...
                string query = "UPDATE [dbo].[sales] SET [AmountPaid] = [AmountPaid]+"+amount+" WHERE [refID]="+refID;
